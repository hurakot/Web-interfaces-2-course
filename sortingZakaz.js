...
//Переменные, используемые в блоке с комментарием и в правом столбце в блоке оформить заказ 
let leftChoiceSoup = document.getElementById('leftChoiceSoup');
let leftChoiceMainDish = document.getElementById('leftChoiceMainDish');
let leftChoiceSalad = document.getElementById('leftChoiceSalad');
let leftChoiceJuice = document.getElementById('leftChoiceJuice');
let leftChoiceDessert = document.getElementById('leftChoiceDessert');


//Загрузка всех сохранённых значений на сайт
...
let tableSoup = document.getElementById('tableSoup');//Табличка с супами
let tableDish = document.getElementById('tableDish');//Табличка с главным блюдом
let tableJuice = document.getElementById('tableJuice');//Табличка с напитком
let tableSalad = document.getElementById('tableSalad');//Табличка с салатом
let tableDessert = document.getElementById('tableDessert');//Табличка с десертом
...
function saveDishes() {
    ...
    localStorage.setItem('leftChoiceSoup', JSON.stringify(dishes));
}
...
//Сохраняем введённые значения
    ...
    localStorage.setItem('textarea1', JSON.stringify(textarea1.value));
    
    localStorage.setItem('email', JSON.stringify(email.value));
    localStorage.setItem('checkEmail', JSON.stringify(checkEmail.checked));
    localStorage.setItem('number', JSON.stringify(number.value));
    localStorage.setItem('address', JSON.stringify(address.value));
    localStorage.setItem('faster', JSON.stringify(faster.checked));
    localStorage.setItem('toTheTime', JSON.stringify(toTheTime.checked));
    localStorage.setItem('time2', JSON.stringify(time2.value));
